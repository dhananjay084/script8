(function () {
  const AFFILIATE_LINK =
    "https://app.partnerboost.com/track/29866z0tk04zwPKxMm_bVwZdLOwuG6H3h3sX4TgcJrHgNld_b1JCnAeMJ334rnUcQApgKei4zo5MrmFNcP3enA?url=https%3A%2F%2Fwww.wattcycle.com%2F&uid=079590";
  const COOKIES = [
  ...
  =============================== */
/* ===============================
   IST HOURLY SCHEDULER
   Runs 1 hour ON, 1 hour OFF
   (Runs on ODD hours only)
=============================== */
function isAllowedISTTime() {
  ...
  // Run only on even hours:
  // 12–1 AM (0), 2–3 AM (2), 4–5 AM (4), etc.
  return hour % 2 === 0;
}
